...
namespace Testing
{
	partial class TestAggregate
	{
		...
		public System.Collections.Generic.IEnumerable<Purview.EventSourcing.Interfaces.Aggregates.Events.IEvent> GetUnsavedEvents() { return _events.ToArray(); }

		public System.Boolean CanApplyEvent(Purview.EventSourcing.Interfaces.Aggregates.Events.IEvent aggregateEvent) { return _eventTypes.Contains(aggregateEvent.GetType()); }
		...
		public void ApplyEvent(Purview.EventSourcing.Interfaces.Aggregates.Events.IEvent @event)
		{
			var details = Details;
			if (details.Locked)
			{
